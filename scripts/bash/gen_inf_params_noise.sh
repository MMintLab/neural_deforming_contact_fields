...
OUT_BASE="out/experiments/primitives/model_v2/eval_inference_noise_gen"
...
python scripts/plot/plot_inf_params_single.py $OUT_BASE/random/ $OUT_BASE/embed_iter/0.001_50/ $OUT_BASE/embed_iter/0.001_100/ $OUT_BASE/embed_iter/0.0001_50/ $OUT_BASE/embed_iter/0.0001_100/ $OUT_BASE/embed_iter.csv
