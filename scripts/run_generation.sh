...
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v1 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v2 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v3 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v4 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v5 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v6 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v7 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/wrench_v8 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/no_wrench_v1 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/no_wrench_v2 -m test
python scripts/eval_results.py cfg/dataset/wrench_v2_tests.yaml out/experiments/wrench_v2_tests/partial_pointcloud_v2/forward_def_v1 -m test
