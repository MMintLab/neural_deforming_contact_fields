...
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v1.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v1/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v2.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v2/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v3.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v3/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v4.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v4/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v5.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v5/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v6.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v6/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v7.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v7/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/wrench_v8.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/wrench_v8/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/no_wrench_v1.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/no_wrench_v1/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/no_wrench_v2.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/no_wrench_v2/
#python scripts/tune_contact_threshold.py cfg/wrench_v2_tests/forward_def_v1.yaml cfg/dataset/wrench_v2_val.yaml -o out/experiments/wrench_v2_tests/tune_generation_v3/forward_def_v1/
