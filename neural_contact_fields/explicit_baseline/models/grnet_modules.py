...
import torch
from neural_contact_fields.explicit_baseline.grnet.extensions.gridding import Gridding, GriddingReverse
from neural_contact_fields.explicit_baseline.grnet.extensions.cubic_feature_sampling import CubicFeatureSampling
...
class GRNet_encoder(torch.nn.Module):
    def __init__(self, cfg):
        super(GRNet_encoder, self).__init__()
    ...
    def forward(self, data):
        ...
        features_lst = [features, pt_features_4_l, pt_features_8_l, pt_features_16_l, pt_features_32_l,pt_features_64_l ]
        return features_lst

class GRNet_decoder(torch.nn.Module):
    def __init__(self, cfg, z_deform_size = 0):
        super(GRNet_decoder, self).__init__()
        self.gridding = Gridding(scale=64)
    ...
    def forward(self, data, feat, features_lst):
        ...
        pt_features_16_l = features_lst[3]
        pt_features_32_l = features_lst[4]
        pt_features_64_l = features_lst[5]
